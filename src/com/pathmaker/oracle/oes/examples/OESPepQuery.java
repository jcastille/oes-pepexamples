...
public class OESPepQuery {
    ...
    public static void main(String[] args) throws Exception {
    	...
    	if (args.length < 4) {
        	System.out.println("Usage: OESPepQuery <application_name> <resource_type> <resource_name> <user_name>");
            System.exit(0);
        ...
        app.pepQueryExample(APPLICATION_NAME,RESOURCE_TYPE,RESOURCE_NAME,USER_NAME);
        System.exit(0);
    }
    
    @SuppressWarnings("rawtypes")
	public void pepQueryExample(String APPLICATION_NAME, String RESOURCE_TYPE, String RESOURCE_NAME, String USER_NAME){
    	Subject subject;
    	subject = new Subject();
